...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "src/simulation.c" 2
# 1 "src/../includes/simulation.h" 1




# 1 "src/../includes/parse_config.h" 1
...
# 5 "src/../includes/parse_config.h" 2
...
# 1 "/usr/lib/llvm-12/lib/clang/12.0.1/include/stddef.h" 1 3 4
# 46 "/usr/lib/llvm-12/lib/clang/12.0.1/include/stddef.h" 3 4
typedef long unsigned int size_t;
# 34 "/usr/include/stdio.h" 2 3 4


# 1 "/usr/lib/llvm-12/lib/clang/12.0.1/include/stdarg.h" 1 3 4
# 14 "/usr/lib/llvm-12/lib/clang/12.0.1/include/stdarg.h" 3 4
typedef __builtin_va_list va_list;
# 32 "/usr/lib/llvm-12/lib/clang/12.0.1/include/stdarg.h" 3 4
...
# 6 "src/../includes/parse_config.h" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 7 "src/../includes/parse_config.h" 2
...
# 1 "/usr/lib/llvm-12/lib/clang/12.0.1/include/stddef.h" 1 3 4
# 74 "/usr/lib/llvm-12/lib/clang/12.0.1/include/stddef.h" 3 4
typedef int wchar_t;
...
# 8 "src/../includes/parse_config.h" 2
...
# 2 "src/simulation.c" 2
# 1 "src/../includes/coder.h" 1
...
# 3 "src/simulation.c" 2
# 1 "src/../includes/dongle.h" 1
# 4 "src/simulation.c" 2
# 1 "src/../includes/monitor.h" 1
...
# 5 "src/../includes/monitor.h" 2

void *monitor_routine(void *arg);
# 5 "src/simulation.c" 2

static int alloc_simulation(t_simulation *sim);

int init_simulation(t_simulation *sim, t_config *config)
{
  pthread_mutex_init(&sim->sim_mutex, ((void*)0));
 pthread_mutex_init(&sim->stop_mutex, ((void*)0));
  pthread_mutex_init(&sim->log_mutex, ((void*)0));
 sim->should_stop = 0;
 if (!sim || !config)
  return (0);
 sim->config = *config;
...
int start_simulation(t_simulation *sim)
{
 ...
 if (pthread_create(&sim->monitor_thread, ((void*)0), monitor_routine, sim))
  return (0);
 return (1);
}
...
void wait_simulation(t_simulation *sim)
{
 ...
 while (i < sim->config.number_of_coders)
 {
  pthread_join(sim->coders[i].thread, ((void*)0));
  i++;
 }
 pthread_join(sim->monitor_thread, ((void*)0));
}
